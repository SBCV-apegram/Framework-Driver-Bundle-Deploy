# PowerShell Script for deploying the Driver Bundle for the Framework Laptop 13 (Intel 12th-gen mainboard)
# Speed up download cmdlet
$ProgressPreference = 'SilentlyContinue'

# Download Current Driver Bundle
Invoke-WebRequest https://downloads.frame.work/driver/Framework_Laptop_12th_Gen_Intel_Core_driver_bundle_W11_2022_07_26.exe -OutFile $env:TEMP\frameworkinstall.exe
